...
- Automatically suggest for addition of rules in .copilot-instructions.md where best practice in used in the code generation
- Automatically suggest for changing of rules in .copilot-instructions.md where best code generation caused problrms and bugs.
- Automatically suggest for updating of rules in .copilot-instructions.md where if a new coding style is interduced in my codebase. 
